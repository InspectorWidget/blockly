...
Blockly.Msg.DELETE_TEMPLATE_CONFIRMATION = "Delete %1 uses of the '%2' template?";  // untranslated
...
Blockly.Msg.TEMPLATES_DEFAULT_NAME = "template";  // untranslated
Blockly.Msg.TEMPLATES_GET_CREATE_SET = "Create 'set %1'";  // untranslated
Blockly.Msg.TEMPLATES_GET_HELPURL = "https://github.com/InspectorWidget/blockly/";  // untranslated
Blockly.Msg.TEMPLATES_GET_TOOLTIP = "Returns the value of this template.";  // untranslated
Blockly.Msg.TEMPLATES_SET = "set %1 to %2";  // untranslated
Blockly.Msg.TEMPLATES_SET_CREATE_GET = "Create 'get %1'";  // untranslated
Blockly.Msg.TEMPLATES_SET_HELPURL = "https://github.com/InspectorWidget/blockly/";  // untranslated
Blockly.Msg.TEMPLATES_SET_TOOLTIP = "Sets this template to be equal to the input.";  // untranslated
Blockly.Msg.TEMPLATE_ALREADY_EXISTS = "A template named '%1' already exists.";  // untranslated
